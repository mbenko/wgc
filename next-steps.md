...
- [app/myApi.bicep](./infra/app/myApi.bicep) - Azure Container Apps resources to host the 'myApi' service.
- [app/myApp.bicep](./infra/app/myApp.bicep) - Azure Container Apps resources to host the 'myApp' service.
